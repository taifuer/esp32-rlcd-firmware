...
RLCD_ESP_AUDIO_CODEC_DIR="${RLCD_EXTERNAL_DEPS_DIR}/sources/espressif/espressif__esp_audio_codec"
RLCD_ESP_AUDIO_CODEC_ARCHIVE="${RLCD_EXTERNAL_DEPS_DIR}/downloads/espressif__esp_audio_codec-v${ESP_AUDIO_CODEC_VERSION}.zip"
...
export RLCD_ESP_AUDIO_CODEC_DIR
